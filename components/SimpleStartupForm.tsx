    ...
    <form action={formAction} className="startup-form">
      ...
      <div>
        ...
        <Textarea
          ...
          required
          placeholder="Briefly describe your idea and what problem it solves. You can use markdown formatting."
        />
...
export default SimpleStartupForm;
